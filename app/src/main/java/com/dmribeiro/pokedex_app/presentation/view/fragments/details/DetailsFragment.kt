...
class DetailsFragment : Fragment(), PokemonListener {
    ...
    override fun onCreateView(
        ...
        window.statusBarColor = resources.getColor(setTypeBackground(args.currentPokemon.types[0].name))
        setupViews()
        setArguments()
    ...
    private fun setupViews(){
        binding.constraintParent.setTypeColor(args.currentPokemon.types[0].name)
